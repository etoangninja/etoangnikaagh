...
<div class="regis-form">
  ...
  <div class="col-12">
    <label for="inputPrefferedDate" class="form-label">Preffered Date</label>
    <input type="text" class="form-control" id="inputPrefferedDate" placeholder="MM/DD/YYYY">
  </div>
  <div class="col-md-6">
    <label for="inputPrefferedTime" class="form-label">Preffered Time </label>
    <input type="text" class="form-control" id="inputPrefferedTime">
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-4">
    ...
    <select id="inputMessComm" class="form-select">
